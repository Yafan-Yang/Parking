...
public class LoginController {
    ...
    public FebsResponse userOnline(String username) throws Exception {
        try {
            ...
            log.warn("Redis unavailable, return empty online user list");
            return new FebsResponse().data(Collections.emptyList());
        }
    }
    ...
    public void kickout(@NotBlank(message = "{required}") @PathVariable String id) throws Exception {
        try {
            ...
            log.warn("Redis unavailable, skip kicking out user {}", id);
        }
    }
    ...
    private String saveTokenToRedis(User user, JWTToken token, HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            log.warn("Redis unavailable, continue login without online-session cache");
